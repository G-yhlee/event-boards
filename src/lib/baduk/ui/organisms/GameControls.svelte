<script lang="ts">
	...
	let { onStartGame, onPass, onResign, onNewGame, status, currentPlayer }: Props = $props();
...
<div class="game-controls">
	{#if status === 'waiting' && !showConfig}
		<button class="primary-button" onclick={handleShowConfig}> 🎯 Start New Game </button>
	{:else if status === 'playing'}
		<div class="playing-controls">
			<button class="action-button pass" onclick={onPass}> ⏭️ Pass </button>
			<button class="action-button resign" onclick={onResign}> 🏳️ Resign </button>
		</div>
	{:else if status === 'finished'}
		<button class="primary-button" onclick={onNewGame}> 🔄 New Game </button>
	{/if}
		...
		<div class="config-modal">
			<div class="modal-content">
				...
				<div class="modal-actions">
					<button class="secondary-button" onclick={handleCancelConfig}> Cancel </button>
					<button class="primary-button" onclick={handleStartGame}> Start Game </button>
				</div>
			</div>
		</div>
	{/if}
